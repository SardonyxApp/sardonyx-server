...
// Initial validation
app.get('/api/validate', auth.createBody, auth.obtainToken, auth.loginToManagebac, auth.initiateStudent, task.loadManagebac, mb.loadDefaults);

// Reissue tokens
app.get('/api/login', auth.createBody, auth.obtainToken, auth.loginToManagebac, end200);

// Initial login
// use upload.none() when it's only text fields
app.post('/api/login', upload.none(), auth.obtainToken, auth.loginToManagebac, auth.initiateStudent, task.loadManagebac, mb.loadDefaults);
