...
// Initial validation
app.get('/api/validate', auth.loginTokenToBody, auth.loginToManagebac, mb.loadDeadlines, mb.loadClasses, mb.loadGroups, mb.encode, end200);
...
app.post('/api/login', upload.none(), auth.loginToManagebac, auth.createSardonyxToken, mb.loadDeadlines, mb.loadClasses, mb.loadGroups, mb.encode, end200);
